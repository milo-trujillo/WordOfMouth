...
{
	string key = "Password";
	string orig = "This is a longer and more thorough test";
	string cyphered = cypher(orig, key);
	string done = decypher(cyphered, key);
	cout << "Orig: " << orig << endl;
	cout << "Done: " << done << endl;
	if( orig == done && orig != cyphered )
		cout << "Cyphers operating correctly" << endl;
	printf("Cypher: %s\n", cyphered.c_str());
	return 0;
}
*/
